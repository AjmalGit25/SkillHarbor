      ...
      <div className='text-white container mx-auto'>
        ...
        <div className='flex flex-col items-center mt-5'>
          <div className='flex items-center gap-3'>
            <span className='w-5 border-t bg-white'></span>
            <h1 className='font-light text-orange-500'>Admin</h1>
            <span className='w-5 border-t bg-white'></span>
          </div>
          <p className='text-xs font-thin tracking-widest'>You are on admin page</p>
        </div>
